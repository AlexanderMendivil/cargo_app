...
export class Convert {
    public static toVehicleInterface(json: string): VehicleInterface {
        return cast(JSON.parse(json), r("VehicleInterface"));
    }

    public static vehicleInterfaceToJson(value: VehicleInterface): string {
        return JSON.stringify(uncast(value, r("VehicleInterface")), null, 2);
    }
}
